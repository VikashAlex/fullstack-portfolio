...
const page = () => {
    ...
    const skillsEdit = (e) => {
        ...
        Axiosinstance.put(`/skills/update/${skill_id}`, formData).then((res) => {
            if (res.data.success) {
    ...
    useEffect(() => {
        Axiosinstance.get(`/skills/get/${skill_id}`).then((res) => {
            if(res.data.success){
            ...
            <div>
                ...
                <header className="mb-8 flex flex-col gap-2">
                    ...
                    <h1 className="text-3xl font-bold tracking-tight flex items-center gap-3 mb-4">
                        ...
                        <span>Edit Now <span className="text-cyan-400">Skill</span></span>
                    </h1>
                ...
                <div className="relative">
                    ...
                    <form onSubmit={skillsEdit} className="relative bg-slate-900/80 border border-white/5 rounded-3xl p-8 shadow-[0_24px_60px_rgba(15,23,42,0.95)] backdrop-blur-xl space-y-6">
                        {/* Small badge */}
